...
def train_neural_network():  
    ...
    with tf.Session(config=Session_config) as sess:
        ...
        last_epoch = load_model(sess, saver,'model1/') 

        for epoch in range(last_epoch + 1,5):
            ...
            saver.save(sess, 'model1/poetry.module', global_step=epoch) 
...
def gen_head_poetry(heads, type, module, last_state, probs, cell, initial_state):
...
if __name__ == '__main__':
    _, last_state, probs, cell, initial_state = neural_network()
    print(gen_head_poetry('这是一首藏头诗', 7, 'model/poetry.module-99', last_state, probs, cell, initial_state)) 
